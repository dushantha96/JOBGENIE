...
def services(service_name=None):
    # Your existing service templates mapping
    service_templates = {
    ...
    # Sidebar links data
    sidebar_links = [
        {"name": "Resume Matching", "endpoint": "services", "service_name": "resume-matching"},
        {"name": "Job Description Analysis", "endpoint": "services", "service_name": "job-description"},
        {"name": "Resume Score Calculator", "endpoint": "services", "service_name": "resume-score"},
        {"name": "Smart Resume Screening", "endpoint": "services", "service_name": "smart-screening"},
    ]

    # Features list data (same for all service sections)
    features = [
        "Brand Development",
        "Brand Guidelines",
        "Brand Templates",
    ...
    services = [
        {
            ...
            "description": ("Our AI-Powered Resume Matching system intelligently compares resumes with job "
        ...
        },
        {
            ...
            "description": ("This tool breaks down job descriptions into their core components—key skills, "
        ...
        },
        {
            ...
            "description": ("Our Resume Score Calculator evaluates how well a resume aligns with a given job "
        ...
        },
        {
            ...
            "description": ("Smart Resume Screening uses AI to automatically review and rank large volumes of "
    ...
    if service_name is None:
        # Show overview services page with all services listed
